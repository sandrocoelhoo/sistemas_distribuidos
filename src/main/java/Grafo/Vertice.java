...
public class Vertice implements org.apache.thrift.TBase<Vertice, Vertice._Fields>, java.io.Serializable, Cloneable, Comparable<Vertice> {
  ...
  public java.util.Map<java.lang.Integer,Aresta> HashAresta; // required
  ...
  public Vertice(
    ...
    double peso,
    java.util.Map<java.lang.Integer,Aresta> HashAresta)
  {
    this();
    this.nome = nome;
    setNomeIsSet(true);
  ...
  public Vertice(Vertice other) {
    ...
    if (other.isSetHashAresta()) {
      java.util.Map<java.lang.Integer,Aresta> __this__HashAresta = new java.util.HashMap<java.lang.Integer,Aresta>(other.HashAresta.size());
      for (java.util.Map.Entry<java.lang.Integer, Aresta> other_element : other.HashAresta.entrySet()) {

        java.lang.Integer other_element_key = other_element.getKey();
        Aresta other_element_value = other_element.getValue();

        java.lang.Integer __this__HashAresta_copy_key = other_element_key;
  ...
  public void putToHashAresta(int key, Aresta val) {
    if (this.HashAresta == null) {
      this.HashAresta = new java.util.HashMap<java.lang.Integer,Aresta>();
    }
    this.HashAresta.put(key, val);
  }

  public java.util.Map<java.lang.Integer,Aresta> getHashAresta() {
    return this.HashAresta;
  }

  public Vertice setHashAresta(java.util.Map<java.lang.Integer,Aresta> HashAresta) {
    this.HashAresta = HashAresta;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case HASH_ARESTA:
      if (value == null) {
        ...
        setHashAresta((java.util.Map<java.lang.Integer,Aresta>)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetHashAresta()) ? 131071 : 524287);
    if (isSetHashAresta())
      hashCode = hashCode * 8191 + HashAresta.hashCode();
  ...
  public int compareTo(Vertice other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetHashAresta()).compareTo(other.isSetHashAresta());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetHashAresta()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.HashAresta = new java.util.HashMap<java.lang.Integer,Aresta>(2*_map0.size);
                int _key1;
                Aresta _val2;
                for (int _i3 = 0; _i3 < _map0.size; ++_i3)
                {
                  ...
                  _val2 = new Aresta();
                  _val2.read(iprot);
                  struct.HashAresta.put(_key1, _val2);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Vertice struct) throws org.apache.thrift.TException {
      ...
      if (struct.HashAresta != null) {
        oprot.writeFieldBegin(HASH_ARESTA_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, Aresta> _iter4 : struct.HashAresta.entrySet())
          {
      ...
      if (struct.isSetHashAresta()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, Aresta> _iter5 : struct.HashAresta.entrySet())
          {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.HashAresta = new java.util.HashMap<java.lang.Integer,Aresta>(2*_map6.size);
          int _key7;
          Aresta _val8;
          for (int _i9 = 0; _i9 < _map6.size; ++_i9)
          {
            ...
            _val8 = new Aresta();
            _val8.read(iprot);
            struct.HashAresta.put(_key7, _val8);
          }
        }
        struct.setHashArestaIsSet(true);
      }
